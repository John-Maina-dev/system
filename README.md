...
## Overview
A comprehensive web-based inventory management system designed specifically for Reeves Enterprises' multi-location operations. The system addresses the company's transition from manual paper-based tracking to a computerized solution.

## System Features

### Core Functionality
- **Multi-Location Support**: Manages inventory across Reeves Branch Eldoret, Reeves Branch Kisumu, Reeves Branch Mombasa, and Reeves Branch Nairobi
...
3. **Default Login Credentials**:
   ...
   - **Eldoret Manager**: Username: `manager_eldoret`, Password: `manager123`
   - **Kisumu Manager**: Username: `manager_kisumu`, Password: `manager123`
   - **Mombasa Manager**: Username: `manager_mombasa`, Password: `manager123`
   - **Nairobi Manager**: Username: `manager_nairobi`, Password: `manager123`
   - **Eldoret Staff**: Username: `staff_eldoret`, Password: `staff123`
   - **Kisumu Staff**: Username: `staff_kisumu`, Password: `staff123`
   - **Mombasa Staff**: Username: `staff_mombasa`, Password: `staff123`
   - **Nairobi Staff**: Username: `staff_nairobi`, Password: `staff123`
...
### Stock Distribution
Stock levels are distributed across all four locations with realistic quantities that demonstrate various stock status conditions.
...
This system successfully addresses Reeves Enterprises' inventory management challenges while providing a foundation for future growth and enhancement.