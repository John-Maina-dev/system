# Reeves Enterprises - SDLC Analysis

## 1. PLANNING PHASE

### Current System Analysis
- **Manual Process**: Paper-based tracking and spreadsheets
- **Locations**: Reeves Branch Eldoret, Reeves Branch Kisumu, Reeves Branch Mombasa, Reeves Branch Nairobi
- **Problems**: 
...
### Deployment Plan
- **Pilot**: Start with one Reeves branch (Reeves Branch Eldoret)
