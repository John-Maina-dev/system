...
('Reeves Branch Eldoret', 'warehouse', 'Eldoret'),
('Reeves Branch Kisumu', 'warehouse', 'Kisumu'),
('Reeves Branch Mombasa', 'warehouse', 'Mombasa'),
('Reeves Branch Nairobi', 'warehouse', 'Nairobi');
